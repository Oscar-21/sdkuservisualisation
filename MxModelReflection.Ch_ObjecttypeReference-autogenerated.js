(function (unit, model) {
	 ...
	 * from unit with id "0fdb7b3a-dfca-4024-b8b1-f92b1850a15b" of type Microflows$Microflow
	...
	token1.relativeMiddlePoint = {"x":100,"y":110};
	...
	actionActivity2.relativeMiddlePoint = {"x":365,"y":200};
	...
	endEvent1.relativeMiddlePoint = {"x":475,"y":200};
	...
	var ch_ObjecttypeReference1 = microflows.Microflow.createIn(unit);
	ch_ObjecttypeReference1.name = "Ch_ObjecttypeReference";
	ch_ObjecttypeReference1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	ch_ObjecttypeReference1.flows.push(sequenceFlow1);
	ch_ObjecttypeReference1.flows.push(sequenceFlow2);
	ch_ObjecttypeReference1.flows.push(sequenceFlow3);
	ch_ObjecttypeReference1.microflowReturnType = voidType1;
	ch_ObjecttypeReference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.ModelAdministrator"));
	ch_ObjecttypeReference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.TokenUser"));
	ch_ObjecttypeReference1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
