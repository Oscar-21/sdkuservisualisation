(function (unit, model) {
	 ...
	 * from unit with id "ef6e827e-025d-4e6b-9690-51fbc78e0ee6" of type Microflows$Microflow
	 * in working copy "SoccerSquad"
	 * on 20-12-2024.
	 */

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":140,"y":295};
	startEvent1.size = {"width":20,"height":20};

	var stringType1 = datatypes.StringType.create(model);

	var referenceSearchString1 = microflows.MicroflowParameterObject.create(model);
	referenceSearchString1.relativeMiddlePoint = {"x":140,"y":185};
	referenceSearchString1.size = {"width":30,"height":30};
	referenceSearchString1.name = "ReferenceSearchString";
	referenceSearchString1.variableType = stringType1;   // Note: for this property a default value is defined.

	var objectType1 = datatypes.ObjectType.create(model);
	objectType1.entity = model.findEntityByQualifiedName("MxModelReflection.MxObjectType");

	var mxObjectType_optional1 = microflows.MicroflowParameterObject.create(model);
	mxObjectType_optional1.relativeMiddlePoint = {"x":140,"y":110};
	mxObjectType_optional1.size = {"width":30,"height":30};
	mxObjectType_optional1.name = "MxObjectType_optional";
	mxObjectType_optional1.variableType = objectType1;   // Note: for this property a default value is defined.

	var expressionSplitCondition1 = microflows.ExpressionSplitCondition.create(model);
	expressionSplitCondition1.expression = "$MxObjectType_optional != empty";

	var exclusiveSplit1 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit1.relativeMiddlePoint = {"x":255,"y":295};
	exclusiveSplit1.size = {"width":110,"height":50};
	exclusiveSplit1.splitCondition = expressionSplitCondition1;   // Note: for this property a default value is defined.
	exclusiveSplit1.caption = "has objecttype?";

	var endEvent1 = microflows.EndEvent.create(model);
	endEvent1.relativeMiddlePoint = {"x":255,"y":615};
	...
	attributeRef1.attribute = model.findAttributeByQualifiedName("MxModelReflection.MxObjectReference.CompleteName");
	...
	databaseRetrieveSource1.entity = model.findEntityByQualifiedName("MxModelReflection.MxObjectReference");
	databaseRetrieveSource1.range = constantRange1;   // Note: for this property a default value is defined.
	databaseRetrieveSource1.xPathConstraint = "[CompleteName=$ReferenceSearchString]\n[MxModelReflection.MxObjectReference_MxObjectType=$MxObjectType_optional]\n";
	...
	retrieveAction1.outputVariableName = "RetrievedReference_ByObjectType";

	var actionActivity1 = microflows.ActionActivity.create(model);
	actionActivity1.relativeMiddlePoint = {"x":460,"y":505};
	...
	expressionSplitCondition2.expression = "$ReferenceSearchString != empty";

	var exclusiveSplit2 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit2.relativeMiddlePoint = {"x":255,"y":505};
	...
	expressionSplitCondition3.expression = "$ReferenceSearchString != empty";

	var exclusiveSplit3 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit3.relativeMiddlePoint = {"x":460,"y":295};
	...
	endEvent2.relativeMiddlePoint = {"x":460,"y":405};
	...
	attributeRef2.attribute = model.findAttributeByQualifiedName("MxModelReflection.MxObjectReference.CompleteName");
	...
	databaseRetrieveSource2.entity = model.findEntityByQualifiedName("MxModelReflection.MxObjectReference");
	databaseRetrieveSource2.range = constantRange2;   // Note: for this property a default value is defined.
	databaseRetrieveSource2.xPathConstraint = "[CompleteName=$ReferenceSearchString]";
	...
	retrieveAction2.outputVariableName = "RetrievedReference";

	var actionActivity2 = microflows.ActionActivity.create(model);
	actionActivity2.relativeMiddlePoint = {"x":675,"y":295};
	...
	attributeRef3.attribute = model.findAttributeByQualifiedName("MxModelReflection.MxObjectReference.CompleteName");
	...
	databaseRetrieveSource3.entity = model.findEntityByQualifiedName("MxModelReflection.MxObjectReference");
	databaseRetrieveSource3.range = constantRange3;   // Note: for this property a default value is defined.
	databaseRetrieveSource3.xPathConstraint = "[contains(CompleteName,$ReferenceSearchString)]";
	...
	retrieveAction3.outputVariableName = "RetrievedReference_1";

	var actionActivity3 = microflows.ActionActivity.create(model);
	actionActivity3.relativeMiddlePoint = {"x":1045,"y":295};
	...
	expressionSplitCondition4.expression = "$RetrievedReference != empty";

	var exclusiveSplit4 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit4.relativeMiddlePoint = {"x":845,"y":295};
	...
	exclusiveSplit4.caption = "Is RetrievedReference?";

	var endEvent3 = microflows.EndEvent.create(model);
	endEvent3.relativeMiddlePoint = {"x":845,"y":395};
	endEvent3.size = {"width":20,"height":20};
	endEvent3.returnValue = "$RetrievedReference";

	var endEvent4 = microflows.EndEvent.create(model);
	endEvent4.relativeMiddlePoint = {"x":1195,"y":295};
	endEvent4.size = {"width":20,"height":20};
	endEvent4.returnValue = "$RetrievedReference_1";
	...
	attributeRef4.attribute = model.findAttributeByQualifiedName("MxModelReflection.MxObjectReference.CompleteName");
	...
	databaseRetrieveSource4.entity = model.findEntityByQualifiedName("MxModelReflection.MxObjectReference");
	databaseRetrieveSource4.range = constantRange4;   // Note: for this property a default value is defined.
	databaseRetrieveSource4.xPathConstraint = "[contains(CompleteName,$ReferenceSearchString)]\n[MxModelReflection.MxObjectReference_MxObjectType=$MxObjectType_optional]\n";
	...
	retrieveAction4.outputVariableName = "RetrievedReference_ByObjectType_1";

	var actionActivity4 = microflows.ActionActivity.create(model);
	actionActivity4.relativeMiddlePoint = {"x":805,"y":505};
	...
	endEvent5.relativeMiddlePoint = {"x":1015,"y":505};
	endEvent5.size = {"width":20,"height":20};
	endEvent5.returnValue = "$RetrievedReference_ByObjectType_1";

	var expressionSplitCondition5 = microflows.ExpressionSplitCondition.create(model);
	expressionSplitCondition5.expression = "$RetrievedReference_ByObjectType != empty";

	var exclusiveSplit5 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit5.relativeMiddlePoint = {"x":630,"y":505};
	...
	exclusiveSplit5.caption = "is RetrievedReference?";

	var endEvent6 = microflows.EndEvent.create(model);
	endEvent6.relativeMiddlePoint = {"x":630,"y":610};
	endEvent6.size = {"width":20,"height":20};
	endEvent6.returnValue = "$RetrievedReference_ByObjectType";

	var microflowObjectCollection1 = microflows.MicroflowObjectCollection.create(model);
	microflowObjectCollection1.objects.push(startEvent1);
	microflowObjectCollection1.objects.push(referenceSearchString1);
	microflowObjectCollection1.objects.push(mxObjectType_optional1);
	...
	objectType2.entity = model.findEntityByQualifiedName("MxModelReflection.MxObjectReference");
	...
	var findReference1 = microflows.Microflow.createIn(unit);
	findReference1.name = "FindReference";
	findReference1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	findReference1.flows.push(sequenceFlow1);
	findReference1.flows.push(sequenceFlow2);
	findReference1.flows.push(sequenceFlow3);
	findReference1.flows.push(sequenceFlow4);
	findReference1.flows.push(sequenceFlow5);
	findReference1.flows.push(sequenceFlow6);
	findReference1.flows.push(sequenceFlow7);
	findReference1.flows.push(sequenceFlow8);
	findReference1.flows.push(sequenceFlow9);
	findReference1.flows.push(sequenceFlow10);
	findReference1.flows.push(sequenceFlow11);
	findReference1.flows.push(sequenceFlow12);
	findReference1.flows.push(sequenceFlow13);
	findReference1.flows.push(sequenceFlow14);
	findReference1.flows.push(sequenceFlow15);
	findReference1.microflowReturnType = objectType2;
	findReference1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
