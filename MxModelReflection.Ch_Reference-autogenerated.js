(function (unit, model) {
	 ...
	 * from unit with id "e50c2475-f55b-4987-aeb9-03621f6fe39b" of type Microflows$Microflow
	...
	startEvent1.relativeMiddlePoint = {"x":100,"y":90};
	...
	actionActivity1.relativeMiddlePoint = {"x":210,"y":90};
	...
	actionActivity2.relativeMiddlePoint = {"x":365,"y":90};
	...
	endEvent1.relativeMiddlePoint = {"x":475,"y":90};
	...
	var ch_Reference1 = microflows.Microflow.createIn(unit);
	ch_Reference1.name = "Ch_Reference";
	ch_Reference1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	ch_Reference1.flows.push(sequenceFlow1);
	ch_Reference1.flows.push(sequenceFlow2);
	ch_Reference1.flows.push(sequenceFlow3);
	ch_Reference1.microflowReturnType = voidType1;
	ch_Reference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.ModelAdministrator"));
	ch_Reference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.TokenUser"));
	ch_Reference1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
