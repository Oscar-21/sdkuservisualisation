(function (unit, model) {
	 ...
	 * from unit with id "4dc9a570-24d3-4f49-ba40-92e4a70b8bfc" of type Microflows$Microflow
	 * in working copy "SoccerSquad"
	 * on 20-12-2024.
	 */

	var memberChange1 = microflows.MemberChange.create(model);
	memberChange1.attribute = model.findAttributeByQualifiedName("PerformanceTest.Staff.FullName");
	memberChange1.value = "$FullName";

	var memberChange2 = microflows.MemberChange.create(model);
	memberChange2.attribute = model.findAttributeByQualifiedName("PerformanceTest.Staff.LicenseNumber");
	memberChange2.value = "'Mx' + $Sequence + $CounterStaff";

	var memberChange3 = microflows.MemberChange.create(model);
	memberChange3.attribute = model.findAttributeByQualifiedName("PerformanceTest.Staff.EmailAddress");
	memberChange3.value = "replaceAll($FullName,' ','.') + '@gomake.it'";

	var memberChange4 = microflows.MemberChange.create(model);
	memberChange4.attribute = model.findAttributeByQualifiedName("PerformanceTest.Staff.Function");
	...
	createObjectAction1.entity = model.findEntityByQualifiedName("PerformanceTest.Staff");
	createObjectAction1.outputVariableName = "NewStaff";

	var actionActivity1 = microflows.ActionActivity.create(model);
	actionActivity1.relativeMiddlePoint = {"x":1235,"y":200};
	...
	exclusiveSplit1.relativeMiddlePoint = {"x":1600,"y":200};
	...
	actionActivity2.relativeMiddlePoint = {"x":1230,"y":85};
	...
	exclusiveMerge1.relativeMiddlePoint = {"x":850,"y":200};
	...
	actionActivity3.relativeMiddlePoint = {"x":1425,"y":200};
	...
	actionActivity4.relativeMiddlePoint = {"x":650,"y":200};
	actionActivity4.size = {"width":120,"height":60};
	actionActivity4.action = createVariableAction1;

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":320,"y":200};
	startEvent1.size = {"width":20,"height":20};

	var endEvent1 = microflows.EndEvent.create(model);
	endEvent1.relativeMiddlePoint = {"x":1915,"y":200};
	...
	sequence1.relativeMiddlePoint = {"x":320,"y":65};
	...
	createListAction1.entity = model.findEntityByQualifiedName("PerformanceTest.Staff");
	...
	actionActivity5.action = createListAction1;
	...
	actionActivity6.relativeMiddlePoint = {"x":1775,"y":200};
	...
	actionActivity7.relativeMiddlePoint = {"x":1035,"y":200};
	...
	sequenceFlow2.destinationConnectionIndex = 1;
	...
	sequenceFlow4.originConnectionIndex = 3;
	...
	listType1.entity = model.findEntityByQualifiedName("PerformanceTest.Staff");
	...
	var sUB_Staff_CreateTenStaff1 = microflows.Microflow.createIn(unit);
	sUB_Staff_CreateTenStaff1.name = "SUB_Staff_CreateTenStaff";
	sUB_Staff_CreateTenStaff1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow1);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow2);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow3);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow4);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow5);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow6);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow7);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow8);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow9);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow10);
	sUB_Staff_CreateTenStaff1.flows.push(sequenceFlow11);
	sUB_Staff_CreateTenStaff1.microflowReturnType = listType1;
	sUB_Staff_CreateTenStaff1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
	...
	sequenceFlow3.destination = actionActivity7;
