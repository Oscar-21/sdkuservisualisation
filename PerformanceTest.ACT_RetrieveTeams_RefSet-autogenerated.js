(function (unit, model) {
	 ...
	 * from unit with id "d627cdfd-3e88-4371-970b-88d9996e063e" of type Microflows$Microflow
	...
	endEvent1.relativeMiddlePoint = {"x":895,"y":200};
	...
	actionActivity1.relativeMiddlePoint = {"x":-30,"y":200};
	...
	retrieveAction1.outputVariableName = "Team_2List";

	var actionActivity2 = microflows.ActionActivity.create(model);
	actionActivity2.relativeMiddlePoint = {"x":180,"y":200};
	...
	actionActivity3.relativeMiddlePoint = {"x":755,"y":200};
	...
	result1.relativeMiddlePoint = {"x":-175,"y":60};
	...
	var aCT_RetrieveTeams_RefSet1 = microflows.Microflow.createIn(unit);
	aCT_RetrieveTeams_RefSet1.name = "ACT_RetrieveTeams_RefSet";
	aCT_RetrieveTeams_RefSet1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	aCT_RetrieveTeams_RefSet1.flows.push(sequenceFlow1);
	aCT_RetrieveTeams_RefSet1.flows.push(sequenceFlow2);
	aCT_RetrieveTeams_RefSet1.flows.push(sequenceFlow3);
	aCT_RetrieveTeams_RefSet1.flows.push(sequenceFlow4);
	aCT_RetrieveTeams_RefSet1.flows.push(sequenceFlow5);
	aCT_RetrieveTeams_RefSet1.flows.push(sequenceFlow6);
	aCT_RetrieveTeams_RefSet1.microflowReturnType = voidType1;
	aCT_RetrieveTeams_RefSet1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("PerformanceTest.PerformanceTester"));
	aCT_RetrieveTeams_RefSet1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
