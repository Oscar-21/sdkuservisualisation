(function (unit, model) {
	 ...
	 * from unit with id "a6818fc3-b9b0-469a-98aa-918de3fac3b1" of type Microflows$Microflow
	...
	associationRetrieveSource1.association = model.findAssociationBaseByQualifiedName("MxModelReflection.Token_MxObjectType_Referenced");
	...
	retrieveAction1.outputVariableName = "MxObjectTypeReference";

	var actionActivity1 = microflows.ActionActivity.create(model);
	actionActivity1.relativeMiddlePoint = {"x":735,"y":365};
	...
	microflowCallParameterMapping1.argument = "$Token/FindMemberReference";
	...
	microflowCallParameterMapping2.argument = "$MxObjectTypeReference";
	...
	microflowCallAction1.outputVariableName = "MxObjectMemberRef";

	var actionActivity2 = microflows.ActionActivity.create(model);
	actionActivity2.relativeMiddlePoint = {"x":895,"y":365};
	actionActivity2.size = {"width":130,"height":60};
	actionActivity2.action = microflowCallAction1;
	actionActivity2.caption = "Try to find the member by the search string";
	actionActivity2.autoGenerateCaption = false;

	var expressionSplitCondition1 = microflows.ExpressionSplitCondition.create(model);
	expressionSplitCondition1.expression = "$MxObjectMemberRef != empty";

	var exclusiveSplit1 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit1.relativeMiddlePoint = {"x":1030,"y":365};
	exclusiveSplit1.size = {"width":60,"height":40};
	exclusiveSplit1.splitCondition = expressionSplitCondition1;   // Note: for this property a default value is defined.
	exclusiveSplit1.caption = "found?";

	var memberChange1 = microflows.MemberChange.create(model);
	memberChange1.association = model.findAssociationBaseByQualifiedName("MxModelReflection.Token_MxObjectMember");
	memberChange1.value = "$MxObjectMemberRef";
	...
	memberChange2.value = "$MxObjectMemberRef/AttributeName";
	...
	actionActivity3.relativeMiddlePoint = {"x":1175,"y":365};
	...
	translation1.text = "No member found with this name";

	var translation2 = texts.Translation.create(model);
	translation2.languageCode = "nl_NL";
	translation2.text = "Geen attribuut gevonden met deze naam";

	var translation3 = texts.Translation.create(model);
	translation3.languageCode = "en_GB";
	translation3.text = "No member found with this name";

	var translation4 = texts.Translation.create(model);
	translation4.languageCode = "en_ZA";
	translation4.text = "No member found with this name";
	...
	validationFeedbackAction1.attribute = model.findAttributeByQualifiedName("MxModelReflection.Token.FindMemberReference");

	var actionActivity4 = microflows.ActionActivity.create(model);
	actionActivity4.relativeMiddlePoint = {"x":1175,"y":455};
	...
	endEvent1.relativeMiddlePoint = {"x":1275,"y":455};
	endEvent1.size = {"width":20,"height":20};

	var endEvent2 = microflows.EndEvent.create(model);
	endEvent2.relativeMiddlePoint = {"x":1275,"y":365};
	endEvent2.size = {"width":20,"height":20};

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":620,"y":365};
	...
	token1.relativeMiddlePoint = {"x":620,"y":275};
	...
	var ch_FindMemberReference1 = microflows.Microflow.createIn(unit);
	ch_FindMemberReference1.name = "Ch_FindMemberReference";
	ch_FindMemberReference1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	ch_FindMemberReference1.flows.push(sequenceFlow1);
	ch_FindMemberReference1.flows.push(sequenceFlow2);
	ch_FindMemberReference1.flows.push(sequenceFlow3);
	ch_FindMemberReference1.flows.push(sequenceFlow4);
	ch_FindMemberReference1.flows.push(sequenceFlow5);
	ch_FindMemberReference1.flows.push(sequenceFlow6);
	ch_FindMemberReference1.flows.push(sequenceFlow7);
	ch_FindMemberReference1.microflowReturnType = voidType1;
	ch_FindMemberReference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.ModelAdministrator"));
	ch_FindMemberReference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.TokenUser"));
	ch_FindMemberReference1.concurrencyErrorMessage = text2;   // Note: for this property a default value is defined.
