(function (unit, model) {
	 ...
	 * from unit with id "9a15ef2b-96b6-4109-b64a-721491f1964b" of type Microflows$Microflow
	 * in working copy "SoccerSquad"
	 * on 20-12-2024.
	 */

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":170,"y":325};
	...
	exclusiveSplit1.relativeMiddlePoint = {"x":295,"y":325};
	exclusiveSplit1.size = {"width":110,"height":50};
	exclusiveSplit1.splitCondition = expressionSplitCondition1;   // Note: for this property a default value is defined.
	exclusiveSplit1.caption = "has object search string";
	...
	column1.relativeMiddlePoint = {"x":170,"y":230};
	...
	endEvent1.relativeMiddlePoint = {"x":295,"y":495};
	...
	actionActivity1.relativeMiddlePoint = {"x":295,"y":430};
	actionActivity1.size = {"width":100,"height":60};
	actionActivity1.action = changeObjectAction1;
	actionActivity1.caption = "Reset the objecttype selection";
	...
	actionActivity2.relativeMiddlePoint = {"x":490,"y":325};
	actionActivity2.size = {"width":110,"height":60};
	actionActivity2.action = retrieveAction1;
	actionActivity2.caption = "Get the reference";
	...
	microflowCallParameterMapping1.argument = "$Column/FindObjectType";
	...
	validationFeedbackAction1.attribute = model.findAttributeByQualifiedName("ExcelImporter.Column.FindObjectType");

	var actionActivity5 = microflows.ActionActivity.create(model);
	actionActivity5.relativeMiddlePoint = {"x":790,"y":430};
	...
	memberChange3.attribute = model.findAttributeByQualifiedName("ExcelImporter.Column.FindObjectType");
	memberChange3.value = "$ObjectType/CompleteName";

	var memberChange4 = microflows.MemberChange.create(model);
	memberChange4.association = model.findAssociationBaseByQualifiedName("ExcelImporter.Column_MxObjectType_Reference");
	memberChange4.value = "$ObjectType";
	...
	actionActivity6.relativeMiddlePoint = {"x":950,"y":325};
	...
	endEvent3.relativeMiddlePoint = {"x":1060,"y":325};
	...
	var ch_FindObjectType_Reference1 = microflows.Microflow.createIn(unit);
	ch_FindObjectType_Reference1.name = "Ch_FindObjectType_Reference";
	ch_FindObjectType_Reference1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	ch_FindObjectType_Reference1.flows.push(sequenceFlow1);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow2);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow3);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow4);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow5);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow6);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow7);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow8);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow9);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow10);
	ch_FindObjectType_Reference1.flows.push(sequenceFlow11);
	ch_FindObjectType_Reference1.microflowReturnType = voidType1;
	ch_FindObjectType_Reference1.applyEntityAccess = true;
	ch_FindObjectType_Reference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("ExcelImporter.Configurator"));
	ch_FindObjectType_Reference1.concurrencyErrorMessage = text2;   // Note: for this property a default value is defined.
