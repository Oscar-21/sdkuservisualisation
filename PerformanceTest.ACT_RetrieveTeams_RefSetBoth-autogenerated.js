(function (unit, model) {
	 ...
	 * from unit with id "ce589a5f-9173-494b-b069-a608b1c73a5a" of type Microflows$Microflow
	 * in working copy "SoccerSquad"
	 * on 20-12-2024.
	 */

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":-65,"y":200};
	startEvent1.size = {"width":20,"height":20};

	var endEvent1 = microflows.EndEvent.create(model);
	endEvent1.relativeMiddlePoint = {"x":1000,"y":200};
	...
	actionActivity1.relativeMiddlePoint = {"x":75,"y":200};
	...
	actionActivity2.relativeMiddlePoint = {"x":860,"y":200};
	...
	actionActivity3.relativeMiddlePoint = {"x":290,"y":200};
	...
	result1.relativeMiddlePoint = {"x":-65,"y":65};
	...
	actionActivity4.relativeMiddlePoint = {"x":670,"y":200};
	...
	actionActivity5.relativeMiddlePoint = {"x":480,"y":200};
	...
	var aCT_RetrieveTeams_RefSetBoth1 = microflows.Microflow.createIn(unit);
	aCT_RetrieveTeams_RefSetBoth1.name = "ACT_RetrieveTeams_RefSetBoth";
	aCT_RetrieveTeams_RefSetBoth1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	aCT_RetrieveTeams_RefSetBoth1.flows.push(sequenceFlow1);
	aCT_RetrieveTeams_RefSetBoth1.flows.push(sequenceFlow2);
	aCT_RetrieveTeams_RefSetBoth1.flows.push(sequenceFlow3);
	aCT_RetrieveTeams_RefSetBoth1.flows.push(sequenceFlow4);
	aCT_RetrieveTeams_RefSetBoth1.flows.push(sequenceFlow5);
	aCT_RetrieveTeams_RefSetBoth1.flows.push(sequenceFlow6);
	aCT_RetrieveTeams_RefSetBoth1.microflowReturnType = voidType1;
	aCT_RetrieveTeams_RefSetBoth1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("PerformanceTest.PerformanceTester"));
	aCT_RetrieveTeams_RefSetBoth1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
