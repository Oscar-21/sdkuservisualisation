(function (unit, model) {
	 ...
	 * from unit with id "cbdd66c0-7851-4f77-855b-bf2994d7a441" of type Microflows$Microflow
	...
	endEvent1.relativeMiddlePoint = {"x":1100,"y":200};
	...
	logMessageAction1.node = "getCaption(PerformanceTest.LogNodes.Reference_set)";
	...
	databaseRetrieveSource1.entity = model.findEntityByQualifiedName("PerformanceTest.Team_2");
	...
	retrieveAction1.outputVariableName = "Team2";

	var actionActivity3 = microflows.ActionActivity.create(model);
	actionActivity3.relativeMiddlePoint = {"x":200,"y":200};
	...
	databaseRetrieveSource2.entity = model.findEntityByQualifiedName("PerformanceTest.Staff_2");
	databaseRetrieveSource2.range = constantRange2;   // Note: for this property a default value is defined.
	databaseRetrieveSource2.xPathConstraint = "[PerformanceTest.Team_2_Staff_2 = $Team2]";
	...
	retrieveAction2.outputVariableName = "Staff_2List";
	...
	actionActivity5.relativeMiddlePoint = {"x":580,"y":200};
	...
	memberChange1.attribute = model.findAttributeByQualifiedName("PerformanceTest.Result.ReferenceSet");
	...
	actionActivity6.relativeMiddlePoint = {"x":770,"y":200};
	...
	result1.relativeMiddlePoint = {"x":-155,"y":65};
	...
	var aCT_RetrieveStaffOfTeam_RefSet1 = microflows.Microflow.createIn(unit);
	aCT_RetrieveStaffOfTeam_RefSet1.name = "ACT_RetrieveStaffOfTeam_RefSet";
	aCT_RetrieveStaffOfTeam_RefSet1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	aCT_RetrieveStaffOfTeam_RefSet1.flows.push(sequenceFlow1);
	aCT_RetrieveStaffOfTeam_RefSet1.flows.push(sequenceFlow2);
	aCT_RetrieveStaffOfTeam_RefSet1.flows.push(sequenceFlow3);
	aCT_RetrieveStaffOfTeam_RefSet1.flows.push(sequenceFlow4);
	aCT_RetrieveStaffOfTeam_RefSet1.flows.push(sequenceFlow5);
	aCT_RetrieveStaffOfTeam_RefSet1.flows.push(sequenceFlow6);
	aCT_RetrieveStaffOfTeam_RefSet1.flows.push(sequenceFlow7);
	aCT_RetrieveStaffOfTeam_RefSet1.microflowReturnType = voidType1;
	aCT_RetrieveStaffOfTeam_RefSet1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
