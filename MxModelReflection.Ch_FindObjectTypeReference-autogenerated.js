(function (unit, model) {
	 ...
	 * from unit with id "93453fdc-3765-4e49-9445-0768528e7b68" of type Microflows$Microflow
	...
	associationRetrieveSource1.association = model.findAssociationBaseByQualifiedName("MxModelReflection.Token_MxObjectReference");
	...
	retrieveAction1.outputVariableName = "MxObjectReference";

	var actionActivity1 = microflows.ActionActivity.create(model);
	actionActivity1.relativeMiddlePoint = {"x":285,"y":140};
	actionActivity1.size = {"width":120,"height":60};
	actionActivity1.action = retrieveAction1;
	actionActivity1.caption = "Retrieve the associated reference";
	...
	microflowCallParameterMapping1.argument = "$Token/FindObjectReference";
	...
	microflowCallParameterMapping2.argument = "$MxObjectReference";
	...
	actionActivity2.relativeMiddlePoint = {"x":445,"y":140};
	actionActivity2.size = {"width":130,"height":60};
	actionActivity2.action = microflowCallAction1;
	actionActivity2.caption = "Try to find a objecttype by the search string";
	...
	exclusiveSplit1.relativeMiddlePoint = {"x":580,"y":140};
	exclusiveSplit1.size = {"width":60,"height":40};
	exclusiveSplit1.splitCondition = expressionSplitCondition1;   // Note: for this property a default value is defined.
	exclusiveSplit1.caption = "found?";

	var memberChange1 = microflows.MemberChange.create(model);
	memberChange1.attribute = model.findAttributeByQualifiedName("MxModelReflection.Token.FindObjectReference");
	memberChange1.value = "$MxObjectType/CompleteName";

	var memberChange2 = microflows.MemberChange.create(model);
	memberChange2.association = model.findAssociationBaseByQualifiedName("MxModelReflection.Token_MxObjectType_Referenced");
	memberChange2.value = "$MxObjectType";
	...
	actionActivity3.relativeMiddlePoint = {"x":725,"y":140};
	...
	translation1.text = "No objecttype found with this name";

	var translation2 = texts.Translation.create(model);
	translation2.languageCode = "nl_NL";
	translation2.text = "Geen objecttype gevonden met deze naam";

	var translation3 = texts.Translation.create(model);
	translation3.languageCode = "en_GB";
	translation3.text = "No objecttype found with this name";

	var translation4 = texts.Translation.create(model);
	translation4.languageCode = "en_ZA";
	translation4.text = "No objecttype found with this name";
	...
	validationFeedbackAction1.association = model.findAssociationBaseByQualifiedName("MxModelReflection.Token_MxObjectType_Referenced");

	var actionActivity4 = microflows.ActionActivity.create(model);
	actionActivity4.relativeMiddlePoint = {"x":725,"y":230};
	...
	endEvent1.relativeMiddlePoint = {"x":825,"y":230};
	endEvent1.size = {"width":20,"height":20};

	var endEvent2 = microflows.EndEvent.create(model);
	endEvent2.relativeMiddlePoint = {"x":825,"y":140};
	endEvent2.size = {"width":20,"height":20};

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":155,"y":140};
	...
	token1.relativeMiddlePoint = {"x":155,"y":55};
	...
	var ch_FindObjectTypeReference1 = microflows.Microflow.createIn(unit);
	ch_FindObjectTypeReference1.name = "Ch_FindObjectTypeReference";
	ch_FindObjectTypeReference1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	ch_FindObjectTypeReference1.flows.push(sequenceFlow1);
	ch_FindObjectTypeReference1.flows.push(sequenceFlow2);
	ch_FindObjectTypeReference1.flows.push(sequenceFlow3);
	ch_FindObjectTypeReference1.flows.push(sequenceFlow4);
	ch_FindObjectTypeReference1.flows.push(sequenceFlow5);
	ch_FindObjectTypeReference1.flows.push(sequenceFlow6);
	ch_FindObjectTypeReference1.flows.push(sequenceFlow7);
	ch_FindObjectTypeReference1.microflowReturnType = voidType1;
	ch_FindObjectTypeReference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.ModelAdministrator"));
	ch_FindObjectTypeReference1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.TokenUser"));
	ch_FindObjectTypeReference1.concurrencyErrorMessage = text2;   // Note: for this property a default value is defined.
