(function (unit, model) {
	 ...
	 * from unit with id "b930ce4d-47a7-4219-8671-32749164f8f8" of type Microflows$Microflow
	...
	endEvent1.returnValue = "$ImportActionString";
	...
	importActions1.relativeMiddlePoint = {"x":100,"y":70};
	...
	createVariableAction1.variableName = "ImportActionString";
	createVariableAction1.variableType = stringType1;   // Note: for this property a default value is defined.
	createVariableAction1.initialValue = "getKey($ImportActions)";
	...
	annotation1.relativeMiddlePoint = {"x":190,"y":-5};
	annotation1.size = {"width":280,"height":60};
	annotation1.caption = "Parse Enum ImportActions to a String";
	...
	var templateImportActionsToString1 = microflows.Microflow.createIn(unit);
	templateImportActionsToString1.name = "TemplateImportActionsToString";
	templateImportActionsToString1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	templateImportActionsToString1.flows.push(sequenceFlow1);
	templateImportActionsToString1.flows.push(sequenceFlow2);
	templateImportActionsToString1.microflowReturnType = stringType2;
	templateImportActionsToString1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
