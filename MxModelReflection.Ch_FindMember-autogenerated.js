(function (unit, model) {
	 ...
	 * from unit with id "b1c36995-25ad-4b84-87bf-f4936e37dd46" of type Microflows$Microflow
	...
	microflowCallParameterMapping1.argument = "$Token/FindMember";
	...
	actionActivity2.relativeMiddlePoint = {"x":535,"y":200};
	...
	expressionSplitCondition1.expression = "$MxObjectMember != empty";

	var exclusiveSplit1 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit1.relativeMiddlePoint = {"x":670,"y":200};
	...
	memberChange2.association = model.findAssociationBaseByQualifiedName("MxModelReflection.Token_MxObjectMember");
	memberChange2.value = "$MxObjectMember";
	...
	actionActivity3.relativeMiddlePoint = {"x":815,"y":200};
	...
	validationFeedbackAction1.attribute = model.findAttributeByQualifiedName("MxModelReflection.Token.FindMember");

	var actionActivity4 = microflows.ActionActivity.create(model);
	actionActivity4.relativeMiddlePoint = {"x":815,"y":290};
	...
	endEvent1.relativeMiddlePoint = {"x":915,"y":290};
	endEvent1.size = {"width":20,"height":20};

	var endEvent2 = microflows.EndEvent.create(model);
	endEvent2.relativeMiddlePoint = {"x":915,"y":200};
	endEvent2.size = {"width":20,"height":20};

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":265,"y":200};
	...
	token1.relativeMiddlePoint = {"x":265,"y":110};
	...
	var ch_FindMember1 = microflows.Microflow.createIn(unit);
	ch_FindMember1.name = "Ch_FindMember";
	ch_FindMember1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	ch_FindMember1.flows.push(sequenceFlow1);
	ch_FindMember1.flows.push(sequenceFlow2);
	ch_FindMember1.flows.push(sequenceFlow3);
	ch_FindMember1.flows.push(sequenceFlow4);
	ch_FindMember1.flows.push(sequenceFlow5);
	ch_FindMember1.flows.push(sequenceFlow6);
	ch_FindMember1.flows.push(sequenceFlow7);
	ch_FindMember1.microflowReturnType = voidType1;
	ch_FindMember1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.ModelAdministrator"));
	ch_FindMember1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("MxModelReflection.TokenUser"));
	ch_FindMember1.concurrencyErrorMessage = text2;   // Note: for this property a default value is defined.
