(function (unit, model) {
	 ...
	 * from unit with id "bb23e545-6054-4b24-b64d-2f062abeade8" of type Microflows$Microflow
	 * in working copy "SoccerSquad"
	 * on 20-12-2024.
	 */

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":100,"y":255};
	startEvent1.size = {"width":20,"height":20};

	var stringType1 = datatypes.StringType.create(model);

	var microflowSearchString1 = microflows.MicroflowParameterObject.create(model);
	microflowSearchString1.relativeMiddlePoint = {"x":100,"y":145};
	microflowSearchString1.size = {"width":30,"height":30};
	microflowSearchString1.name = "MicroflowSearchString";
	microflowSearchString1.variableType = stringType1;   // Note: for this property a default value is defined.

	var expressionSplitCondition1 = microflows.ExpressionSplitCondition.create(model);
	expressionSplitCondition1.expression = "$MicroflowSearchString != empty";

	var exclusiveSplit1 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit1.relativeMiddlePoint = {"x":210,"y":255};
	exclusiveSplit1.size = {"width":90,"height":60};
	exclusiveSplit1.splitCondition = expressionSplitCondition1;   // Note: for this property a default value is defined.
	exclusiveSplit1.caption = "search str != empty";

	var endEvent1 = microflows.EndEvent.create(model);
	endEvent1.relativeMiddlePoint = {"x":210,"y":365};
	...
	attributeRef1.attribute = model.findAttributeByQualifiedName("MxModelReflection.Microflows.CompleteName");
	...
	databaseRetrieveSource1.xPathConstraint = "[CompleteName=$MicroflowSearchString]";
	...
	retrieveAction1.outputVariableName = "RetrievedMicroflow";

	var actionActivity1 = microflows.ActionActivity.create(model);
	actionActivity1.relativeMiddlePoint = {"x":415,"y":255};
	...
	attributeRef2.attribute = model.findAttributeByQualifiedName("MxModelReflection.Microflows.CompleteName");
	...
	databaseRetrieveSource2.entity = model.findEntityByQualifiedName("MxModelReflection.Microflows");
	databaseRetrieveSource2.range = constantRange2;   // Note: for this property a default value is defined.
	databaseRetrieveSource2.xPathConstraint = "[contains(CompleteName,$MicroflowSearchString)]";
	...
	retrieveAction2.outputVariableName = "RetrievedMicroflow_1";

	var actionActivity2 = microflows.ActionActivity.create(model);
	actionActivity2.relativeMiddlePoint = {"x":775,"y":255};
	...
	expressionSplitCondition2.expression = "$RetrievedMicroflow != empty";

	var exclusiveSplit2 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit2.relativeMiddlePoint = {"x":585,"y":255};
	...
	exclusiveSplit2.caption = "is RetrivedMicroflow?";

	var endEvent2 = microflows.EndEvent.create(model);
	endEvent2.relativeMiddlePoint = {"x":585,"y":360};
	endEvent2.size = {"width":20,"height":20};
	endEvent2.returnValue = "$RetrievedMicroflow";

	var endEvent3 = microflows.EndEvent.create(model);
	endEvent3.relativeMiddlePoint = {"x":925,"y":255};
	endEvent3.size = {"width":20,"height":20};
	endEvent3.returnValue = "$RetrievedMicroflow_1";

	var microflowObjectCollection1 = microflows.MicroflowObjectCollection.create(model);
	microflowObjectCollection1.objects.push(startEvent1);
	microflowObjectCollection1.objects.push(microflowSearchString1);
	...
	objectType1.entity = model.findEntityByQualifiedName("MxModelReflection.Microflows");
	...
	var findMicroflow1 = microflows.Microflow.createIn(unit);
	findMicroflow1.name = "FindMicroflow";
	findMicroflow1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	findMicroflow1.flows.push(sequenceFlow1);
	findMicroflow1.flows.push(sequenceFlow2);
	findMicroflow1.flows.push(sequenceFlow3);
	findMicroflow1.flows.push(sequenceFlow4);
	findMicroflow1.flows.push(sequenceFlow5);
	findMicroflow1.flows.push(sequenceFlow6);
	findMicroflow1.flows.push(sequenceFlow7);
	findMicroflow1.microflowReturnType = objectType1;
	findMicroflow1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
