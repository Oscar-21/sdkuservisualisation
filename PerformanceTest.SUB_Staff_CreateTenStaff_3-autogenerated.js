(function (unit, model) {
	 ...
	 * from unit with id "1c82e6fe-098c-4966-b340-497013a3b974" of type Microflows$Microflow
	...
	exclusiveSplit1.relativeMiddlePoint = {"x":1480,"y":200};
	...
	actionActivity2.relativeMiddlePoint = {"x":1305,"y":200};
	...
	actionActivity3.relativeMiddlePoint = {"x":580,"y":200};
	...
	endEvent1.relativeMiddlePoint = {"x":1795,"y":200};
	...
	sequence1.relativeMiddlePoint = {"x":250,"y":65};
	...
	createListAction1.entity = model.findEntityByQualifiedName("PerformanceTest.Staff_3");
	createListAction1.outputVariableName = "StaffList";

	var actionActivity4 = microflows.ActionActivity.create(model);
	actionActivity4.relativeMiddlePoint = {"x":390,"y":200};
	...
	actionActivity5.relativeMiddlePoint = {"x":1655,"y":200};
	actionActivity5.size = {"width":120,"height":60};
	actionActivity5.action = commitAction1;

	var memberChange1 = microflows.MemberChange.create(model);
	memberChange1.attribute = model.findAttributeByQualifiedName("PerformanceTest.Staff_3.FullName");
	memberChange1.value = "$FullName";

	var memberChange2 = microflows.MemberChange.create(model);
	memberChange2.attribute = model.findAttributeByQualifiedName("PerformanceTest.Staff_3.LicenseNumber");
	memberChange2.value = "'Mx' + $Sequence + $CounterStaff";

	var memberChange3 = microflows.MemberChange.create(model);
	memberChange3.attribute = model.findAttributeByQualifiedName("PerformanceTest.Staff_3.EmailAddress");
	memberChange3.value = "replaceAll($FullName,' ','.') + '@gomake.it'";

	var memberChange4 = microflows.MemberChange.create(model);
	memberChange4.attribute = model.findAttributeByQualifiedName("PerformanceTest.Staff_3.Function");
	...
	createObjectAction1.entity = model.findEntityByQualifiedName("PerformanceTest.Staff_3");
	createObjectAction1.outputVariableName = "NewStaff";

	var actionActivity6 = microflows.ActionActivity.create(model);
	actionActivity6.relativeMiddlePoint = {"x":1120,"y":200};
	...
	actionActivity7.relativeMiddlePoint = {"x":930,"y":200};
	...
	listType1.entity = model.findEntityByQualifiedName("PerformanceTest.Staff_3");
	...
	var sUB_Staff_CreateTenStaff_3_1 = microflows.Microflow.createIn(unit);
	sUB_Staff_CreateTenStaff_3_1.name = "SUB_Staff_CreateTenStaff_3";
	sUB_Staff_CreateTenStaff_3_1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow1);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow2);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow3);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow4);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow5);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow6);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow7);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow8);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow9);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow10);
	sUB_Staff_CreateTenStaff_3_1.flows.push(sequenceFlow11);
	sUB_Staff_CreateTenStaff_3_1.microflowReturnType = listType1;
	sUB_Staff_CreateTenStaff_3_1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
