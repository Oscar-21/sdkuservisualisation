(function (unit, model) {
	 ...
	 * from unit with id "23c5d606-6ca1-41cd-82dc-0af61c615947" of type Microflows$Microflow
	 * in working copy "SoccerSquad"
	 * on 20-12-2024.
	 */

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":-175,"y":200};
	startEvent1.size = {"width":20,"height":20};

	var endEvent1 = microflows.EndEvent.create(model);
	endEvent1.relativeMiddlePoint = {"x":1080,"y":200};
	...
	actionActivity1.relativeMiddlePoint = {"x":-35,"y":200};
	...
	actionActivity2.relativeMiddlePoint = {"x":940,"y":200};
	actionActivity2.size = {"width":120,"height":60};
	actionActivity2.action = logMessageAction1;
	actionActivity2.backgroundColor = microflows.ActionActivityColor.Gray;
	...
	databaseRetrieveSource1.entity = model.findEntityByQualifiedName("PerformanceTest.Team_3");
	...
	retrieveAction1.outputVariableName = "Team3";

	var actionActivity3 = microflows.ActionActivity.create(model);
	actionActivity3.relativeMiddlePoint = {"x":180,"y":200};
	...
	databaseRetrieveSource2.entity = model.findEntityByQualifiedName("PerformanceTest.Staff_3");
	databaseRetrieveSource2.range = constantRange2;   // Note: for this property a default value is defined.
	databaseRetrieveSource2.xPathConstraint = "[PerformanceTest.Member_Staff_3/PerformanceTest.Member/PerformanceTest.Member_Team_3 = $Team3]";
	...
	retrieveAction2.outputVariableName = "Staf_3list";

	var actionActivity4 = microflows.ActionActivity.create(model);
	actionActivity4.relativeMiddlePoint = {"x":370,"y":200};
	...
	actionActivity5.action = createVariableAction2;
	actionActivity5.backgroundColor = microflows.ActionActivityColor.Gray;

	var memberChange1 = microflows.MemberChange.create(model);
	memberChange1.attribute = model.findAttributeByQualifiedName("PerformanceTest.Result.JoiningEntity");
	...
	actionActivity6.relativeMiddlePoint = {"x":750,"y":200};
	...
	result1.relativeMiddlePoint = {"x":-175,"y":65};
	...
	var aCT_RetrieveStaffOfTeam_JoinEntity1 = microflows.Microflow.createIn(unit);
	aCT_RetrieveStaffOfTeam_JoinEntity1.name = "ACT_RetrieveStaffOfTeam_JoinEntity";
	aCT_RetrieveStaffOfTeam_JoinEntity1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	aCT_RetrieveStaffOfTeam_JoinEntity1.flows.push(sequenceFlow1);
	aCT_RetrieveStaffOfTeam_JoinEntity1.flows.push(sequenceFlow2);
	aCT_RetrieveStaffOfTeam_JoinEntity1.flows.push(sequenceFlow3);
	aCT_RetrieveStaffOfTeam_JoinEntity1.flows.push(sequenceFlow4);
	aCT_RetrieveStaffOfTeam_JoinEntity1.flows.push(sequenceFlow5);
	aCT_RetrieveStaffOfTeam_JoinEntity1.flows.push(sequenceFlow6);
	aCT_RetrieveStaffOfTeam_JoinEntity1.flows.push(sequenceFlow7);
	aCT_RetrieveStaffOfTeam_JoinEntity1.microflowReturnType = voidType1;
	aCT_RetrieveStaffOfTeam_JoinEntity1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
