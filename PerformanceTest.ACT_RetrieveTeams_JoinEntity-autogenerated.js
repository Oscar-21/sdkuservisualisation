(function (unit, model) {
	 ...
	 * from unit with id "d5443208-c56d-417d-8bac-76a08b60a99b" of type Microflows$Microflow
	...
	endEvent1.relativeMiddlePoint = {"x":990,"y":200};
	...
	actionActivity1.relativeMiddlePoint = {"x":45,"y":200};
	...
	retrieveAction1.outputVariableName = "Team_3List";

	var actionActivity2 = microflows.ActionActivity.create(model);
	actionActivity2.relativeMiddlePoint = {"x":245,"y":200};
	...
	actionActivity3.relativeMiddlePoint = {"x":860,"y":200};
	actionActivity3.size = {"width":120,"height":60};
	actionActivity3.action = logMessageAction1;
	actionActivity3.backgroundColor = microflows.ActionActivityColor.Gray;
	...
	result1.relativeMiddlePoint = {"x":-95,"y":65};
	...
	var aCT_RetrieveTeams_JoinEntity1 = microflows.Microflow.createIn(unit);
	aCT_RetrieveTeams_JoinEntity1.name = "ACT_RetrieveTeams_JoinEntity";
	aCT_RetrieveTeams_JoinEntity1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	aCT_RetrieveTeams_JoinEntity1.flows.push(sequenceFlow1);
	aCT_RetrieveTeams_JoinEntity1.flows.push(sequenceFlow2);
	aCT_RetrieveTeams_JoinEntity1.flows.push(sequenceFlow3);
	aCT_RetrieveTeams_JoinEntity1.flows.push(sequenceFlow4);
	aCT_RetrieveTeams_JoinEntity1.flows.push(sequenceFlow5);
	aCT_RetrieveTeams_JoinEntity1.flows.push(sequenceFlow6);
	aCT_RetrieveTeams_JoinEntity1.microflowReturnType = voidType1;
	aCT_RetrieveTeams_JoinEntity1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("PerformanceTest.PerformanceTester"));
	aCT_RetrieveTeams_JoinEntity1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
