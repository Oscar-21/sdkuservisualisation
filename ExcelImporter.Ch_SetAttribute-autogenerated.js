(function (unit, model) {
	 ...
	 * from unit with id "299e77b7-94d8-40a3-a2b2-6e198dcd8b68" of type Microflows$Microflow
	 * in working copy "SoccerSquad"
	 * on 20-12-2024.
	 */

	var startEvent1 = microflows.StartEvent.create(model);
	startEvent1.relativeMiddlePoint = {"x":95,"y":205};
	...
	column1.relativeMiddlePoint = {"x":95,"y":120};
	...
	expressionSplitCondition1.expression = "$column/ExcelImporter.Column_MxObjectMember != empty";

	var exclusiveSplit1 = microflows.ExclusiveSplit.create(model);
	exclusiveSplit1.relativeMiddlePoint = {"x":210,"y":205};
	...
	actionActivity1.relativeMiddlePoint = {"x":400,"y":205};
	...
	endEvent1.relativeMiddlePoint = {"x":210,"y":375};
	endEvent1.size = {"width":20,"height":20};

	var endEvent2 = microflows.EndEvent.create(model);
	endEvent2.relativeMiddlePoint = {"x":675,"y":205};
	...
	actionActivity2.relativeMiddlePoint = {"x":565,"y":205};
	...
	actionActivity3.relativeMiddlePoint = {"x":210,"y":305};
	...
	var ch_SetAttribute1 = microflows.Microflow.createIn(unit);
	ch_SetAttribute1.name = "Ch_SetAttribute";
	ch_SetAttribute1.objectCollection = microflowObjectCollection1;   // Note: for this property a default value is defined.
	ch_SetAttribute1.flows.push(sequenceFlow1);
	ch_SetAttribute1.flows.push(sequenceFlow2);
	ch_SetAttribute1.flows.push(sequenceFlow3);
	ch_SetAttribute1.flows.push(sequenceFlow4);
	ch_SetAttribute1.flows.push(sequenceFlow5);
	ch_SetAttribute1.flows.push(sequenceFlow6);
	ch_SetAttribute1.microflowReturnType = voidType1;
	ch_SetAttribute1.applyEntityAccess = true;
	ch_SetAttribute1.allowedModuleRoles.push(model.findModuleRoleByQualifiedName("ExcelImporter.Configurator"));
	ch_SetAttribute1.concurrencyErrorMessage = text1;   // Note: for this property a default value is defined.
